...
parser.add_argument('--model_file', type=str, default='/root/autodl-tmp/best_model_4_1.11_0.422_1.347.pth')
...
if __name__ == '__main__':
    ...
    for step, (image, depth_image, label, mask_path, img_path) in enumerate(tqdm(TestLoader)):
        ego_pred = model.test_forward(image.cuda(), depth_image.cuda(), label.long().cuda(), img_path)
        cluster_sim_maps = []
